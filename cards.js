...
var scenarios = [
  {
    ...
    playerCards : [
      {
        description : "I never use public wifi networks anytime.",
        power : 5,
      },
      {
  ...
  },
  {
    ...
    playerCards : [
      ...
      {
        description : "I sent the details you asked for so you could check on my account regarding details.",
        power : 1,
      }
    ]
  },
  {
    ...
    playerCards : [
      ...
      {
        description : "I keep my accounts private so only my friends can see them and tag.",
        power : 4,
      },
      {
        description : "I tag everything and everyone (MAD TAG)so my friends always know what I’m doing.",
        power : 1,
      }
    ]
  },
  ...
  },
  {
    ...
    playerCards : [
      ...
      {
        description : "I never clear my browser history because I don’t like typing in big web addresses (Lazy).",
        power : 1,
      }
    ]
  }
